...
<style>
/* Adjust the size of the artist blocks */
.single-artist-item {
    width: 100%; /* Ensure each block takes up the full width of its container */
    max-width: 200px; /* Set a maximum width for the artist blocks */
...
/* Style the artist info */
.artist-info {
    text-align: center; /* Center-align the artist info */
}

/* Optionally, add hover effects or other styles */
.single-artist-item:hover {
    /* Add hover effects */
}
    ...
    <!-- ##### Artist Category Area Start ##### -->
    <section class="artist-catagory section-padding-100-0">
        <div class="container">
            <div class="row">
                <div class="col-12">
            ...
            <div class="row oneMusic-artists">
    @foreach($artists as $artist)
        <!-- Single artist -->
        <div class="col-6 col-md-3 single-artist-item">
